...
public class kerberos {
    ...
    public static void main(String[] args) throws Exception {
        ...
        conf.set("fs.default.name", "hdfs://eng-cdh1:8020");
        ...
        kerberosUGI.doAs((PrivilegedExceptionAction<Void>) () -> {
            ...
            conf.set("fs.hdfs.impl.disable.cache", "true");
            fs.getFileStatus(new Path("/")); // ← kerberosUGI can authenticate via Kerberos
        ...
        tokenUGI.doAs((PrivilegedExceptionAction<Void>) () -> {
            ...
            fileSystem.getFileStatus(new Path("/")); // ← tokenUGI can authenticate via Delegation Token
            return null;
        });
