...
import com.example.hadoop.util.DateUtil;
...
import static com.example.hadoop.ColumnType.*;
...
public class HDfs {
    ...
    private static void write(List<String> fullColumnNames) throws Exception {
        ...
        getData(recordList, INT, "12233");
        getData(recordList, TIMESTAMP, "2020-08-27 20:15:08.000000");
        getData(recordList, TIMESTAMP, "2020-08-27 20:15:08.000000");
        getData(recordList, STRING, "test2");
        getData(recordList, DATE, new Timestamp(System.currentTimeMillis()).toString());
